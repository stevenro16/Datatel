...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        {{-- Reports --}}
        <a href="{{ route('admin.reports.index') }}" class="{{ request()->routeIs('admin.reports*') ? 'active' : '' }}" style="display:flex;align-items:center;gap:.65rem;" data-tooltip="Reports">
        ...
        {{-- My Analytics --}}
        <a href="{{ route('admin.my-analytics') }}" class="{{ request()->routeIs('admin.my-analytics') ? 'active' : '' }}" style="display:flex;align-items:center;gap:.65rem;" data-tooltip="My Analytics">
            ...
            <span class="nav-label" style="flex:1;">My Analytics</span>
        </a>
